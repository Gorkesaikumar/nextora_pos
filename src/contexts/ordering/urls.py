...
urlpatterns = [
    ...
    path("product/<uuid:product_id>/modifiers/", views.POSModifierModalView.as_view(), name="pos_modifier_modal"),
    path("<uuid:tenant_id>/product/<uuid:product_id>/modifiers/", views.POSModifierModalView.as_view(), name="pos_modifier_modal_tenant"),
    path("combo/<uuid:combo_id>/", views.POSComboModalView.as_view(), name="pos_combo_modal"),
    path("<uuid:tenant_id>/combo/<uuid:combo_id>/", views.POSComboModalView.as_view(), name="pos_combo_modal_tenant"),
    path("item/<uuid:item_id>/modifiers/", views.POSCartEditModifierModalView.as_view(), name="pos_edit_modifier_modal"),
    path("<uuid:tenant_id>/item/<uuid:item_id>/modifiers/", views.POSCartEditModifierModalView.as_view(), name="pos_edit_modifier_modal_tenant"),
    ...
    path("printer-settings/", views.POSPrinterSettingsView.as_view(), name="printer_settings"),
    path("<uuid:tenant_id>/printer-settings/", views.POSPrinterSettingsView.as_view(), name="printer_settings_tenant"),
    path("printer-settings/select/", views.POSPrinterSelectView.as_view(), name="printer_select"),
    path("<uuid:tenant_id>/printer-settings/select/", views.POSPrinterSelectView.as_view(), name="printer_select_tenant"),
    path("printer-settings/test-print/", views.POSTestPrintView.as_view(), name="test_print"),
    path("<uuid:tenant_id>/printer-settings/test-print/", views.POSTestPrintView.as_view(), name="test_print_tenant"),
    path("printer-settings/status/", views.POSPrintServiceStatusView.as_view(), name="print_service_status"),
    path("<uuid:tenant_id>/printer-settings/status/", views.POSPrintServiceStatusView.as_view(), name="print_service_status_tenant"),
    path("order/<uuid:order_id>/print-receipt/", views.POSPrintReceiptView.as_view(), name="print_receipt"),
    path("<uuid:tenant_id>/order/<uuid:order_id>/print-receipt/", views.POSPrintReceiptView.as_view(), name="print_receipt_tenant"),

    # Invoice Configuration
    path("invoice-config/", views.InvoiceConfigurationView.as_view(), name="invoice_config"),
    path("<uuid:tenant_id>/invoice-config/", views.InvoiceConfigurationView.as_view(), name="invoice_config_tenant"),
    path("invoice-config/save/", views.InvoiceConfigurationSaveView.as_view(), name="invoice_config_save"),
    path("<uuid:tenant_id>/invoice-config/save/", views.InvoiceConfigurationSaveView.as_view(), name="invoice_config_save_tenant"),
    path("invoice-config/preview/", views.InvoiceConfigurationPreviewView.as_view(), name="invoice_config_preview"),
    path("<uuid:tenant_id>/invoice-config/preview/", views.InvoiceConfigurationPreviewView.as_view(), name="invoice_config_preview_tenant"),
    path("invoice/<uuid:invoice_id>/reprint/", views.InvoiceReprintView.as_view(), name="invoice_reprint"),
    path("<uuid:tenant_id>/invoice/<uuid:invoice_id>/reprint/", views.InvoiceReprintView.as_view(), name="invoice_reprint_tenant"),
    path("invoice/<uuid:invoice_id>/snapshot/", views.InvoiceSnapshotDetailView.as_view(), name="invoice_snapshot"),
    path("<uuid:tenant_id>/invoice/<uuid:invoice_id>/snapshot/", views.InvoiceSnapshotDetailView.as_view(), name="invoice_snapshot_tenant"),

    # Invoice Config — Test Print & Reset
    path("invoice-config/test-print/", views.InvoiceConfigurationTestPrintView.as_view(), name="invoice_config_test_print"),
    path("<uuid:tenant_id>/invoice-config/test-print/", views.InvoiceConfigurationTestPrintView.as_view(), name="invoice_config_test_print_tenant"),
    path("invoice-config/reset/", views.InvoiceConfigurationResetView.as_view(), name="invoice_config_reset"),
    path("<uuid:tenant_id>/invoice-config/reset/", views.InvoiceConfigurationResetView.as_view(), name="invoice_config_reset_tenant"),
]
